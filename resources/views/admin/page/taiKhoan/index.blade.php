        ...
        <div class="col-4">
            <div class="card border-primary border-bottom border-3 border-0">
                ...
                <div class="card-footer text-end">
                    <button class="btn btn-inverse-primary" type="button" v-on:click="CreateTaiKhoan()">Tạo Mới</button>
                </div>
            </div>
        </div>
        <div class="col-8">
                            ...
                            <tbody>
                             <tr v-for="(value , key) in list">
                                ...
                                <td class="text-center align-middle text-nwrap">
                                    <button class="btn btn-inverse-success" v-on:click="password_new = value" data-bs-toggle="modal"data-bs-target="#changePasswordModal">Đổi Mật Khẩu</button>

                                    <button class="btn btn-inverse-warning" v-on:click="edit = value" data-bs-toggle="modal" data-bs-target="#updateModal">Cập Nhật</button>
                                    <button class="btn btn-inverse-danger" v-on:click="del = value" data-bs-toggle="modal"data-bs-target="#deleteModal">Xoá</button>
                                </td>
                             </tr>
                            </tbody>
                        </table>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <button type="button" class="btn-inverse-close" data-bs-dismiss="modal"
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-inverse-danger" v-on:click="DelAdmin()">Xóa</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-inverse-secondary"
                                            data-bs-dismiss="modal">Đóng</button>
                                        <button type="button" v-on:click="UpdateAdmin()" class="btn btn-inverse-primary">Cập Nhật</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-inverse-secondary"
                                            data-bs-dismiss="modal">Đóng</button>
                                        <button type="button" class="btn btn-inverse-primary" v-on:click="changePassWord()">Cập Nhật</button>
                                    </div>
                                </div>
                            </div>
                        </div>
