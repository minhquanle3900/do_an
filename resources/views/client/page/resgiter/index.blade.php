                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 inner-column">
                        <div class="inner-box login-inner">
                            <div class="upper-inner">
                                <h3>Đăng Nhập</h3>
                                <p>Đăng nhập để truy cập tất cả các tài nguyên của bạn</p>
                            </div>
                            <form action="/client/resgiter/action" method="post" class="default-form">
                                @csrf
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="custom-controls-stacked">
                                        <label class="custom-control material-checkbox">
                                            ...
                                            <span class="description">Ghi Nhớ</span>
                                        </label>
                                    </div>
                                    <a href="/client/resgiter/lost-pass" class="recover-password">Quên Mật Khẩu?</a>
                                </div>
                                <div class="form-group">
                                    <button type="submit" class="theme-btn-two">Đăng Nhập<i class="flaticon-right-1"></i></button>
                                </div>
                            </form>
                            <div class="lower-inner centred">
                                ...
                                <p>Bạn muốn đổi mật khẩu cho tài khoản? <a href="/client/resgiter/update">Đổi Mật Khẩu!</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-12 inner-column">
                        <div class="inner-box signup-inner">
                            ...
                            <form action="/client/resgiter" method="post" class="default-form">
                                @csrf
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="custom-controls-stacked">
                                        <label class="custom-control material-checkbox">
                                            <input type="checkbox" class="material-control-input">
                                            <span class="material-control-indicator"></span>
                                            <span class="description">Tôi đồng ý với các điều khoản & Chính sách.</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <button type="submit" class="theme-btn-two">Đăng Ký<i class="flaticon-right-1"></i></button>
                                </div>
                            </form>
                            <div class="lower-inner centred">
                                <span>or</span>
                                ...
                                <p>Bạn có sẵn sàng để tạo một tài khoản? <a href="/client/resgiter">Đăng Nhập Ngay!</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 footer-column">
                                    <div class="footer-widget contact-widget">
                                        ...
                                        <ul class="info-list clearfix">
                                            <li><i class="flaticon-maps-and-flags"></i>610 Tôn Đức Thắng, <br />Đà Nẵng</li>
                                            <li><i class="flaticon-phone-ringing"></i><a href="tel:23055873407">+(84) 587-3407</a></li>
                                            <li><i class="flaticon-email"></i> <a href="mailto:info@example.com">cdio4@gmail.com</a></li>
                                        </ul>
