            ...
            <div class="auto-container">
                <div class="content-box">
                    ...
                    <ul class="bread-crumb clearfix">
                        <li><i class="flaticon-home-1"></i><a href="/client">Home</a></li>
                        <li>Tài Khoản</li>
                        <li>Đổi Mật Khẩu</li>
                    </ul>
                </div>
            ...
            <div class="auto-container">
                        ...
                        <div class="inner-box login-inner">
                            ...
                            <form action="/client/resgiter/action" method="post" class="default-form">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="theme-btn-two">Đổi Mật Khẩu<i class="flaticon-right-1"></i></button>
                                </div>
                            </form>
                            <div class="lower-inner centred">
                                <span>or</span>
                                <ul class="social-links clearfix">
                                    <li><a href="/facebook.com"><i class="fab fa-facebook-f"></i>Facebook</a></li>
                                    <li><a href="/google.com"><i class="fab fa-google-plus-g"></i>Google</a></li>
                                </ul>
