            ...
            <div class="auto-container">
                            ...
                            <table class="cart-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="price">65.000 VNĐ</td>
                                        <td class="qty">
                                            <div class="item-quantity">
                                                <input class="quantity-spinner" type="text" value="1" name="quantity">
                                            </div>
                                        </td>
                                        <td class="sub-total">65.000 VNĐ</td>
                                    </tr>
                                    <tr>
                                        <td colspan="4" class="prod-column">
                                            <div class="column-box">
                                        ...
                                        <td class="price">15.000 VNĐ</td>
                                        <td class="qty">
                                            <div class="item-quantity">
                                                <input class="quantity-spinner" type="text" value="2" name="quantity">
                                            </div>
                                        </td>
                                        <td class="sub-total">30.000 VNĐ</td>
                                    </tr>
                                    <tr>
                                        <td colspan="4" class="prod-column">
                                            <div class="column-box">
                                        ...
                                        <td class="price">22.000 VNĐ</td>
                                        <td class="qty">
                                            <div class="item-quantity">
                                                <input class="quantity-spinner" type="text" value="3" name="quantity">
                                            </div>
                                        </td>
                                        <td class="sub-total">66.000 VNĐ</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="othre-content clearfix">
                    <div class="coupon-box pull-left clearfix">
                        ...
                        <button type="submit" class="theme-btn-two">Xác Nhận<i class="flaticon-right-1"></i></button>
                    </div>
                    <div class="update-btn pull-right">
                        <button type="submit" class="theme-btn-one">Chỉnh Sửa<i class="flaticon-right-1"></i></button>
                    </div>
                </div>
                        ...
                        <div class="col-xl-5 col-lg-12 col-md-12 offset-xl-7 cart-column">
                            <div class="total-cart-box clearfix">
                                ...
                                <ul class="list clearfix">
                                    <li>Tổng:<span>150.000 VNĐ</span></li>
                                    <li>Tổng Số Đơn Đặt Hàng:<span>1</span></li>
                                </ul>
                                <a href="/client/thanh-toan" class="theme-btn-two">Chốt Đơn<i class="flaticon-right-1"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
